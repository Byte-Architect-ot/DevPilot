...
export const useRepos = () => {
  ...
  const normalizeRepo = (repo) => ({
    ...
    stars: repo.stars !== undefined ? repo.stars : (repo.chunkCount || 0),
    forks: repo.forks !== undefined ? repo.forks : (repo.filesProcessed || 0),
    ...
    index_status: repo.indexStatus || repo.index_status || 'READY',
